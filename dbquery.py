...
class Database(object):
    def __init__(self):
        ...
        for domain in domains:
            BASE = r'D:\dialogue\db'
            with open(os.path.join(BASE, f'{domain}_db.json'), encoding='utf-8') as f:
...
#     db = Database()
#     constraints = [('food', 'british'), ('area', 'centre'), ('pricerange', 'moderate')]
#     res = db.query('restaurant', constraints)
#     print(res)
if __name__ == '__main__':
